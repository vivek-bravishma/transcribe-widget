...
export const solitaire = {
    ...
    version: '0.5',
    backgroundImage:
        'https://download-ssl.msgamestudios.com/content/mgs/ce/production/SolitaireWin10/dev/adapative_card_assets/v1/card_background.png',
    body: [
        {
            type: 'ColumnSet',
            columns: [
...
export const weatherLarge = {
    ...
    backgroundImage:
        'http://messagecardplayground.azurewebsites.net/assets/Mostly%20Cloudy-Background-Dark.jpg',
    body: [
        {
            type: 'ColumnSet',
            columns: [
                    ...
                    columns: [
                        {
                            ...
                            selectAction: {
                                type: 'Action.ToggleVisibility',
                                title: 'show history',
                                targetElements: ['cardContent4', 'chevronUp4', 'chevronDown4'],
                            },
                            verticalContentAlignment: 'Center',
                            items: [
                                {
                    ...
                    items: [
                        {
                            type: 'Container',
                            backgroundImage:
                                'http://messagecardplayground.azurewebsites.net/assets/TxP_Background.png',
                            items: [
                                {
                                    type: 'Image',
                                    horizontalAlignment: 'Center',
