	...
	return (
		<div className="chat-header">
			<div className="overall-sentiment-container">
				...
				{overallsentiment && (
					<div className="overall-sentiment-icon tooltip">
						{String.fromCodePoint(overallsentiment)}
						<span className="tooltiptext">Overall Sentiment</span>
					</div>
				)}
			</div>
			...
			<div className="checkbox-container">
				<div className="checkbox-inner-contnr">
					<div className="cb-ctr tooltip">
						...
						<span className="tooltiptext">Greeting Done</span>
					</div>
					<div className="cb-ctr tooltip">
						<div className="cb-icon">
							{recording_alert_done
					...
					<div className="cb-ctr tooltip">
						...
						<span className="tooltiptext">Thank You Done</span>
					</div>
				</div>
			</div>
		</div>
